...
def build_section_prompt(
    *,
    ...
    return (
        ...
        "- Use one or two compact paragraphs when the section has multiple claims; avoid a single monolithic template paragraph.\n"
        ...
        "- Change the order and shape of sentences when possible; do not mirror the source or skeleton sentence structure.\n"
        "- Mix claim-led, evidence-led, and qualification-led sentences instead of using a predictable claim-evidence-conclusion pattern.\n"
